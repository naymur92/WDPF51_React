...
if (
  ...
  $add = mysqli_query($db_conn, "UPDATE users SET name ='$username', email ='$useremail', password='$userpass' WHERE id='$userids'");

  if ($add) {
    echo json_encode(["success" => true, "msg" => "Successfully Updated"]);
    return;
  } else {
